...
copy /y %~dp0x64-windows-donly.cmake %~dp0..\vcpkg\triplets\x64-windows.cmake

@echo Installing debug only libs...

%~dp0..\vcpkg\vcpkg.exe install docopt:x64-windows glad:x64-windows glfw3:x64-windows glm:x64-windows ^
